/*
appframework.cpp - Impl for the appframework system
...
EXPORT void* _LoadLibraryA(const char* lib) { return g_load_library(lib); }

EXPORT void _FreeLibrary(void* lib) { g_free_library(lib); }
